...
export default function HipPage() {
  ...
  // Mapeamos las secciones para insertar las imágenes reales
    ...
    <div className="w-full min-h-screen bg-white flex flex-col font-sans relative box-border overflow-x-hidden pt-24">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 py-16 md:py-24 flex flex-col md:flex-row items-center md:items-start justify-between gap-8 md:gap-12 box-border">
        <div className="w-full md:w-1/2 flex flex-col text-left">
           ...
           <h1 className="text-6xl md:text-7xl lg:text-[6rem] font-black text-[#193833] tracking-tighter leading-none uppercase">Cadera</h1>
        </div>
      ...
      <div className="flex flex-col items-center justify-center gap-6 my-10">
        <a href="/catalog/Catalogo_cadera.pdf" download className="flex items-center gap-3 bg-[#32453F] hover:bg-[#193833] text-white font-bold py-4 px-8 rounded-full transition-transform hover:scale-105 uppercase tracking-widest text-sm shadow-xl">
