  ...
  return (
    <div className="w-full min-h-screen bg-white flex flex-col font-sans relative box-border overflow-x-hidden pt-24">
      ...
      <div className="flex flex-col items-center justify-center gap-6 my-10">
        <a href="/catalog/Catálogo_codo.pdf" download className="flex items-center gap-3 bg-[#32453F] hover:bg-[#193833] text-white font-bold py-4 px-8 rounded-full transition-transform hover:scale-105 uppercase tracking-widest text-sm shadow-xl">
