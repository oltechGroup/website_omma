//src/locales/pageservices/knee/es.js
export default {
  nav: { 
    home: "Inicio", 
    catalog: "Catálogo", 
  ...
  hero: {
    ...
    titleLarge: "Rodilla",
    subtitle: "Sistemas primarios y de revisión diseñados con tecnología avanzada para garantizar resultados clínicos superiores."
  },
  portfolio: {
    title: "Portafolio de Rodilla",
    subtitle: "Explora nuestras soluciones para artroplastia primaria, revisiones y componentes especializados."
  },
  sections: [
    {
  ...
  cta: {
    title: "¿Interesado en nuestros productos de rodilla?",
