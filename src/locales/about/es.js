...
export default {
  nav: {
    ...
    // Nuevas claves para el nuevo Navbar
    catalog: "Catálogo",
    meetUs: "Conócenos",
  },
  ...
  hero: {
    ...
    subtitle: "confianza local",
    text: "Innovación ortopédica sin fronteras.",
  },

  mission: {
    title: "Misión",
    text: "Desarrollar, fabricar y distribuir implantes y soluciones ortopédicas de última generación, combinando eficiencia productiva global con excelencia en innovación, trazabilidad y servicio clínico especializado.",
  },

  vision: {
    title: "Visión",
    text: "Ser reconocidos en los próximos 10 años como la marca líder en implantes ortopédicos de Latinoamérica y un referente global en innovación y accesibilidad, consolidando presencia en México, EE. UU., Europa y Asia.",
  },

  values: {
    title: "Nuestros valores",
    hero: "Innovación constante · Excelencia clínica · Confianza y ética · Accesibilidad · Sustentabilidad · Servicio humano",
    items: {
  ...
  positioning:
    "“Somos la opción que combina ingeniería de clase mundial, costos eficientes y servicio local confiable, ofreciendo a los médicos y hospitales la seguridad de un aliado estratégico que entiende sus retos clínicos y financieros.”",
  ...
  clients: {
    ...
    // Nuevo texto utilizado cuando un cliente no tiene sitio web
    ...
    list: [
      {
        ...
        address:
          "Calle Dr. Márquez 162, Doctores, Cuauhtémoc, 06720 Ciudad de México, CDMX",
      ...
      },
      {
        ...
        address:
          "Calz. Ignacio Zaragoza 1711, Iztapalapa, 09220 Ciudad de México, CDMX",
  ...
  footer: {
    ...
    // Nuevas claves para el Footer rediseñado
